                ...
                <CardContent className="">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-7">
                        <div className="flex flex-col gap-1">
                            <Label className="text-md" htmlFor="name">Guest Name</Label>
                            <Input
                                className=""
                                type="text"
                                id="name"
                        ...
                        <div className="flex flex-col gap-1">
                            <Label className="text-md" htmlFor="email">Attendance</Label>
                            <div className="w-full grid grid-cols-2 gap-2 text-center items-center">
                                <label className="cursor-pointer">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-center lg:text-[16px] text-sm"> Will attend</p>
                                        </div>
                                    </div>
                                    </div>
                                </label>
                                <label className="cursor-pointer">
                                    ...
                                    onChange={(e) => setAttendees(e.target.value)}
                                    />
                                    <div className="lg:w-72 max-w-xl p- lg:py-2 py-3 rounded-md bg-[#F8EFD3] ring-2 ring-transparent border border-black/20 transition-all hover:shadow peer-checked:bg-[#F5DB8C]/75 peer-checked:ring-[#9D8443]/50 peer-checked:ring-offset-1 peer-checked:border-none">
                                    <div className="flex flex-col gap-1">
                                        <div className="items-center">
                                        <p className="text-center lg:text-[16px] text-sm">Unable to attend</p>
                                        </div>
                                    </div>
                                    </div>
                                </label>
                        ...
                        <div className="flex flex-col gap-1">
                            <Label className="text-md" htmlFor="email">Number of guests</Label>
                            <div className="w-full grid grid-cols-2 gap-4 text-center items-center">
                                <label className="cursor-pointer">
                                    <input
                                    type="radio" className="peer sr-only"
                                    name="guest"
                                    value="1 Guest"
                        ...
                        />
                        <Button className="lg:mt-4 -mt-7 mb-1 bg-[#F5DB8C] hover:bg-[#f7d05c] border-[#FACB3D] text-black uppercase" type="submit">Submit</Button>
                    </form>
                </CardContent>
            </Card>
        </div>
